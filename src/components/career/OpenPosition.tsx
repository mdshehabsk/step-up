            ...
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div className="mt-4 md:mt-0 flex flex-col md:items-end gap-3">
                  ...
                  <Link aria-label='apply now for job' href={`/job/${job.href}`} className="bg-blue-500 hover:bg-blue-600 text-white font-medium px-6 py-2 rounded-full flex items-center justify-center transition-colors">
                    Apply Now
