          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="bg-gray-800 rounded-lg p-6 mt-8 relative">
              ...
              <div className="flex justify-end gap-2 mt-4">
                <button aria-label="prev navigation button" className="bg-gray-700 hover:bg-gray-600 p-2 rounded-full">
                  <svg aria-hidden className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7"></path>
                  </svg>
                </button>
                <button aria-label="next navigation button" className="bg-gray-700 hover:bg-gray-600 p-2 rounded-full">
                  <svg aria-hidden className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1">
              ...
              <div className="flex space-x-4 mt-6">
                <a aria-label='facebook' href="https://www.facebook.com/stepup4u" target='_blank' className="text-white hover:text-blue-400">
                  <span className="sr-only">Facebook</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                  </svg>
                </a>
                <a aria-label='youtube' href="https://www.youtube.com/@fahmidalnayem" target='_blank' className="text-white hover:text-red-400">
                  <span className="sr-only">YouTube</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" />
                  </svg>
                </a>
                <a aria-label='linkedin' href="https://www.linkedin.com/company/stepup-technology" target='_blank' className="text-white hover:text-blue-500">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                  </svg>
                </a>
                <a aria-label='instagram' href="https://www.facebook.com/stepup4u" target='_blank' className="text-white hover:text-pink-400">
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2">
                <li><Link aria-label='web development' href="/service/#web-design-development" className="text-gray-300 hover:text-white transition">Web Development</Link></li>
                <li><Link  aria-label='digital marketing' href="/service/#digital-marketing" className="text-gray-300 hover:text-white transition">Digital Marketing</Link></li>
                <li><Link aria-label='content solution' href="/service/#content-solutions" className="text-gray-300 hover:text-white transition">Content Solution</Link></li>
                <li><Link aria-label='email and sms marketing' href="/service/#email-sms-marketing" className="text-gray-300 hover:text-white transition">Email & SMS Marketing</Link></li>
                <li><Link aria-label='search engine optimization' href="/service/#search-engine-optimization" className="text-gray-300 hover:text-white transition">Search Engine Optimization</Link></li>
              </ul>
            </div>
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2">
                <li><Link aria-label='about'  href="/about-us" className="text-gray-300 hover:text-white transition">About</Link></li>
                <li><Link aria-label='career'  href="/career" className="text-gray-300 hover:text-white transition">Careers</Link></li>
                <li><Link aria-label='company profile'  href="#" className="text-gray-300 hover:text-white transition">Company Profile</Link></li>
                <li><Link aria-label='contact'  href="/contact-us" className="text-gray-300 hover:text-white transition">Contact</Link></li>
              </ul>
            </div>
